...
Middleware: 
  - Middleware dùng để xác thực người dùng, kiểm tra dữ liệu đầu vào, xử lý session... ghi nhật ký, và xử lý lỗi trước khi yêu cầu được chuyển        đến các phần logic chính của ứng dụng.
